    ...
    if (has_intersection){
        ...
        if(s.spheres[sphere_id].isMirror){
            ...
            if (s.spheres[sphere_id].isTransparent){
                ...
                vector dir_aleat = dir_aleat_repere_local[2]*n + dir_aleat_repere_local[0]*tangent1 + dir_aleat_repere_local[1]*tangent2;
...
int main() {
    ...
    sphere s1_bis(vector (15,0,-30) ,10 , vector (1,1,1)); // sphere a droite de la figure
